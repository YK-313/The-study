...
%axis([min(SIM.ResSi) max(SIM.ResSi) 10^(-4) 10^-3]);
axis([min(SIM.ResSi) max(SIM.ResSi) 10^(-5) 10^-0]);

set(gca,'Linewidth',LW,'FontName',FN,'FontSize',FS,'ytick',10.^[-5:1:-0],'PlotBoxAspectRatio',[1 1 1]);
