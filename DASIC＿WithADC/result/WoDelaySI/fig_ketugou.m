% 1. .figファイルを開く
fig1 = openfig( "sir-90.fig", 'invisible'); % .figファイルを開く
ax = gca; % 現在の軸を取得
...
% 1. .figファイルを開く
fig2 = openfig( "sir-80.fig", 'invisible'); % .figファイルを開く
ax = gca; % 現在の軸を取得
...
% 1. .figファイルを開く
fig3 = openfig( "sir-70.fig",'invisible'); % .figファイルを開く
...
% 1. .figファイルを開く
fig4 = openfig( "sir-60.fig", 'invisible'); % .figファイルを開く
ax = gca; % 現在の軸を取得
...
% 1. .figファイルを開く
fig5 = openfig("1DASICideal.fig", 'invisible'); % .figファイルを開く
ax = gca; % 現在の軸を取得
...
%l(5) = semilogy(xData5, yData5, 'ypentagram-');
l(5) = semilogy(xData5, yData5, 'k-');
%l(6) = semilogy(xData6, yData6, 'k-');
grid on;
legend ('$\mathrm{SIR}=-90$ dB' ,'$\mathrm{SIR}=-80$ dB' ,'$\mathrm{SIR}=-70$ dB' ,'$\mathrm{SIR}=-60$ dB','ideal','FontSize', 25,'FontName', 'Times New Roman','Interpreter','latex' )
