% 1. .figファイルを開く
fig1 = openfig( "AutoSir-80Rho-10.fig", 'invisible'); % .figファイルを開く
ax = gca; % 現在の軸を取得
...
% 1. .figファイルを開く
fig2 = openfig( "AutoSir-80Rho-20.fig", 'invisible'); % .figファイルを開く
ax = gca; % 現在の軸を取得
...
% 1. .figファイルを開く
fig3 = openfig( "AutoSir-80Rho-30.fig",'invisible'); % .figファイルを開く
...
% 1. .figファイルを開く
fig4 = openfig( "AutoSir-80Rho-40.fig", 'invisible'); % .figファイルを開く
ax = gca; % 現在の軸を取得
