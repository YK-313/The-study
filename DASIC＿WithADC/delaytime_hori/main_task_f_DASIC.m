...
function SIM = main_task_f_DASIC(En,idx,SIM,G,delayA)
...
tmp_profile_AA (1:delayA:delayA*num_of_paths_AA)= delay_profile_AA_sir;
for iii = 1 : fft_ptA
...
% SNR_dB = 10 * log10(SNR_linear);
    ...
    RX.s_total = RX.s_AA + RX.s_AB+CH.n ;
...
if intrlv==1
 ...
 BCJR2.decode= BCJR2.decode_bhat>0;
    ...
    fprintf('%d/%d  %d/%d\n',idx,length(SIM.delayA),idx_loop,SIM.nsamp)
end
SIM.En  = En;
