...
symtime=32*10^-6;%シンボル時間長
delay_time=symtime/SIM.nsym/SIM.over*SIM.delayA;%遅延時間
%%%%%%%%%%%%%%
%%%% Task %%%%
%%%%%%%%%%%%%%%
SIM.nsamp   = 10^SIM.w_loop; 
%for idx = 1:length(SIM.delayA)
parfor idx = 1:length(SIM.delayA)
    RES = main_task_f_DASIC(SIM.SNR,idx,SIM,G,SIM.delayA(idx));  
    BER(idx) = RES.BER;                       
end
